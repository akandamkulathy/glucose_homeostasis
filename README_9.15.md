...
Hovering any graph, expanded or small, marks the nearest recorded sample and reports its time and value. Save a run to leave it on the plot and compare two conditions directly. The controls and clock
